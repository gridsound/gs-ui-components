...
GSUsetTemplate( "gsui-com-profile", () => [
	GSUcreateDiv( { class: "gsuiComProfile-main" },
		...
		GSUcreateDiv( { class: "gsuiComProfile-main-info" },
			GSUcreateDiv( { class: "gsuiComProfile-main-username" } ),
			GSUcreateDiv( { class: "gsuiComProfile-main-fullname" },
				GSUcreateSpan( { class: "gsuiComProfile-main-firstname" } ),
				GSUcreateSpan( { class: "gsuiComProfile-main-lastname" } ),
			),
			GSUcreateDiv( { class: "gsuiComProfile-main-email" },
				...
				GSUcreateButton( { class: "gsuiComProfile-main-email-not" },
					...
					GSUcreateSpan( { class: "gsuiComProfile-main-email-toSend" }, "Email not verify, send a confirmation email again" ),
					GSUcreateSpan( { class: "gsuiComProfile-main-email-sent" }, "Email sent" ),
				),
			),
		),
