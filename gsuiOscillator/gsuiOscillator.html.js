			...
			GSUcreateDiv( { class: "gsuiOscillator-waveWrap" },
				GSUcreateDiv( { class: "gsuiOscillator-waveWrap-left" },
					GSUcreateDiv( { class: "gsuiOscillator-waveWrap-top" },
						GSUcreateButton( { class: "gsuiOscillator-wavePrevNext", "data-dir": "-1", icon: "caret-left", title: "Previous wave" } ),
						GSUcreateButton( { class: "gsuiOscillator-wavePrevNext", "data-dir": "1", icon: "caret-right", title: "Next wave" } ),
						GSUcreateButton( { class: "gsuiOscillator-waveName" } ),
						GSUcreateButton( { class: "gsuiOscillator-waveBtn", "data-action": "wavetable", icon: "cu-wave-edit", title: "Open wavetable editor" } ),
