			...
			GSUcreateDiv( { class: "gsuiOscillator-waveWrap" },
				GSUcreateDiv( { class: "gsuiOscillator-waveWrap-left" },
					GSUcreateDiv( { class: "gsuiOscillator-waveWrap-top" },
						GSUcreateButton( { "data-dir": "-1", icon: "caret-left", title: "Previous wave" } ),
						GSUcreateButton( { "data-dir": "1", icon: "caret-right", title: "Next wave" } ),
						GSUcreateButton( { class: "gsuiOscillator-waveName" } ),
						GSUcreateButton( { class: "gsuiOscillator-waveEdit", icon: "cu-wave-edit", title: "Open wavetable editor" } ),
