...
GSUsetTemplate( "gsui-library-sample", obj =>
	GSUcreateDiv( { class: "gsuiLibrary-sample gsuiLibrary-sample-expanded", draggable: "true", "data-id": obj.id, "data-name": obj.name, title: obj.name },
		GSUcreateDiv( { class: "gsuiLibrary-sample-wave" },
