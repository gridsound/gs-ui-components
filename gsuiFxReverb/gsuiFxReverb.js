	...
	constructor() {
		super( {
			...
			$elements: {
				...
				$dryValue: "[data-prop='dry'] output",
				$wetValue: "[data-prop='wet'] output",
				$delValue: "[data-prop='delay'] output",
				$decValue: "[data-prop='decay'] output",
				$fadeinValue: "[data-prop='fadein'] output",
