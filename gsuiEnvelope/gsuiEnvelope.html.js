...
GSUsetTemplate( "gsui-envelope", () => {
	return [
		[
			...
			GSUcreateElement( "div", { class: `gsuiEnvelope-prop gsuiEnvelope-${ prop }`, title },
				GSUcreateElement( "div", { class: "gsuiEnvelope-propLabel" },
					GSUcreateElement( "span", null, text ),
					GSUcreateElement( "div", { class: "gsuiEnvelope-propValue" } ),
				),
				GSUcreateElement( "div", { class: "gsuiEnvelope-propContent" },
					GSUcreateElement( "gsui-slider", { type: "linear-x", disabled: true, min, max, step, "mousemove-size": "800", "data-prop": prop } ),
				),
			)
		),
		GSUcreateElement( "div", { class: "gsuiEnvelope-graph" },
