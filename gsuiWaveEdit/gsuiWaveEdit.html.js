...
GSUsetTemplate( "gsui-wave-edit", () => [
	...
	GSUcreateDiv( { class: "gsuiWaveEdit-waves" },
		GSUgetTemplate( "gsui-wave-edit-wavestep", true ),
		GSUgetTemplate( "gsui-wave-edit-wavestep", null ),
		GSUgetTemplate( "gsui-wave-edit-wavestep", null ),
	),
] );

GSUsetTemplate( "gsui-wave-edit-wavestep", ( sel ) =>
	GSUcreateDiv( { class: "gsuiWaveEdit-wavestep", "data-selected": sel },
