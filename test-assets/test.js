		...
		GSUI.$createElement( "div", { id: "testBody" },
			GSUI.$createElement( "div", { id: "testHead" },
				...
				GSUI.$createElement( "select", { id: "testSelect" },
					...
					GSUI.$createElement( "option", { value: "gsuiDrums" }, "gsuiDrums" ),
					GSUI.$createElement( "option", { value: "gsuiDrumrows" }, "gsuiDrumrows" ),
					GSUI.$createElement( "option", { value: "gsuiDotline" }, "gsuiDotline" ),
					...
					GSUI.$createElement( "option", { value: "gsuiPanels" }, "gsuiPanels" ),
					GSUI.$createElement( "option", { value: "gsuiPianoroll" }, "gsuiPianoroll" ),
