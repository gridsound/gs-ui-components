...
GSUsetTemplate( "gsui-daw", () => [
	GSUcreateDiv( { class: "gsuiDAW-head" },
		...
		GSUcreateDiv( { class: "gsuiDAW-area gsuiDAW-areaCtrl" },
			...
			GSUcreateDiv( { class: "gsuiDAW-btns" },
		...
		GSUcreateDiv( { class: "gsuiDAW-area gsuiDAW-areaVers" },
			GSUcreateAExt( { class: "gsuiDAW-btn", "data-action": "version", title: "Changelog", href: "https://github.com/gridsound/daw/wiki/changelog" },
				GSUcreateSpan( { class: "gsuiDAW-version" } ),
