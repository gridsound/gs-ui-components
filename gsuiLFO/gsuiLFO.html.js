	...
	GSUcreateDiv( { class: "gsuiLFO-in" },
		...
		GSUcreateDiv( { class: "gsuiLFO-type" },
			[
				...
				GSUcreateLabel( { title: w },
					GSUcreateInput( { name: "gsuiLFO-type", type: "radio", value: w } ),
					GSUcreateElement( "svg", { viewBox: "0 0 14 10", inert: true },
						GSUcreateElement( "path", { d: dots } ),
					),
				)
			),
		),
		GSUcreateDiv( { class: "gsuiLFO-graph" },
			GSUcreateDiv( { class: "gsuiLFO-wave", inert: true },
			...
			GSUcreateDiv( { class: "gsuiLFO-ampSigns" },
				GSUcreateLabel( null,
					GSUcreateInput( { name: "gsuiLFO-ampSign", type: "radio", value: "1" } ),
					GSUcreateIcon( { icon: "caret-up" } ),
				),
				GSUcreateLabel( null,
					GSUcreateInput( { name: "gsuiLFO-ampSign", type: "radio", value: "-1" } ),
					GSUcreateIcon( { icon: "caret-down" } ),
				),
			),
		),
	)
