...
GSUI.$setTemplate( "gsui-timewindow", () => [
	GSUI.$createElement( "div", { class: "gsuiTimewindow-panel" },
		GSUI.$createElement( "div", { class: "gsuiTimewindow-panelUp" },
			...
			GSUI.$createElement( "gsui-slider", { "data-zoom": "y", type: "linear-y", "mousemove-size": 400, min: 0, max: 1, step: .01 } ),
			GSUI.$createElement( "gsui-slider", { "data-zoom": "x", type: "linear-y", "mousemove-size": 400, min: 0, max: 1, step: .01 } ),
		),
