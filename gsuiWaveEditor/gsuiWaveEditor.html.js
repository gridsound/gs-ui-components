	...
	GSUcreateFlex( { class: "gsuiWaveEditor-in", x: true, f1: true },
		...
		GSUcreateFlex( { class: "gsuiWaveEditor-menu", y: true, g6: true },
			...
			GSUcreateFlex( { class: "gsuiWaveEditor-mirror", x: true, g4: true },
				GSUcreateButton( { "data-dir": "x", icon: "mirror-x" } ),
				GSUcreateElement( "gsui-slider", { action: "mirror-x", type: "linear-x", min: -1, max: 1, step: .001, "mousemove-size": 800 } ),
			),
			GSUcreateFlex( { class: "gsuiWaveEditor-mirror", x: true, g4: true },
				GSUcreateButton( { "data-dir": "y", icon: "mirror-y" } ),
				GSUcreateElement( "gsui-slider", { action: "mirror-y", type: "linear-x", min: -1, max: 1, step: .001, "mousemove-size": 800 } ),
			),
			GSUcreateFlex( { class: "gsuiWaveEditor-phase", y: true, g6: true },
				GSUcreateSpan( { class: "gsuiWaveEditor-label" }, "phase" ),
				GSUcreateElement( "gsui-slider", { action: "phase", type: "linear-x", min: -1, max: 1, step: .001, "mousemove-size": 800 } ),
			),
