...
$.$setTemplate( "gsui-drumrow", () => [
	...
	$.$div( { class: "gsuiDrumrow-main" },
		...
		$.$button( { class: "gsuiDrumrow-btnProps",  "data-action": "props",  "data-tooltip": GSTX.$drumrow_expand }, $.$icon( { icon: "drumprops" } ) ),
		$.$button( { class: "gsuiDrumrow-btnDelete", "data-action": "delete", "data-tooltip": GSTX.$drumrow_remove }, $.$icon( { icon: "close" } ) ),
